...
@RestController
@RequestMapping("/api/v1/agentfs/folders")
public class AgentFSFolderController {

    private final AgentFSFolderService service;

    public AgentFSFolderController(AgentFSFolderService service) {
    ...
    private AgentFSFolderProfile profileFromBody(Map<String, Object> body) {
        return AgentFSFolderProfile.normalize(
    ...
    private Map<String, Object> toMap(AgentFSFolderEntity e) {
