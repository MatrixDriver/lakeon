...
class LBFSAutoJobRecorderTest {
    ...
    void records_succeeded_auto_job_for_registered_folder() {
        ...
        LBFSAutoJobEntity job = recorder.record(
                ...
                new AgentFSProcessingEvent("tn_1", "/datasets/orders.csv", "etag_1", "put"),
                AgentFSProcessingResult.done("profiled csv"));
    ...
    void reuses_existing_job_for_same_source_etag_and_marks_retrying() {
        ...
        LBFSAutoJobEntity job = recorder.record(
                ...
                new AgentFSProcessingEvent("tn_1", existing.getSourcePath(), "etag_1", "put"),
                AgentFSProcessingResult.retry("missing worker: iceberg"));
    ...
    private static AgentFSFolderEntity folder(String tenantId, String id, String processingProfile) {
