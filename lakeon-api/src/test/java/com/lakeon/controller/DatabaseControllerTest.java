...
class DatabaseControllerTest {
    ...
    class CreateDatabase {
        ...
        void create_success_returns201() throws Exception {
            ...
            mockMvc.perform(post("/api/v1/databases")
                    ...
                    .andExpect(jsonPath("$.pooled_connection_uri").value("postgres://user:pass@proxy.lakeon.example.com/my-app-db?options=endpoint%3Dmy-app-db-pooler"))
    ...
    private DatabaseResponse buildDatabaseResponse(String id, String name, DatabaseStatus status) {
        return DatabaseResponse.builder()
                ...
                .name(name)
                .status(status)
                .connectionUri("postgres://user:pass@proxy.lakeon.example.com/" + name + "?options=endpoint%3D" + name)
                .pooledConnectionUri("postgres://user:pass@proxy.lakeon.example.com/" + name + "?options=endpoint%3D" + name + "-pooler")
                .computeSize("2cu")
                .suspendTimeout("10m")
                .storageLimitGb(10)
                .storageUsedGb(0.0)
