...
const roles = computed(() => [
  { key: 'family', icon: 'Home', title: t('家庭管家', 'Family Manager'), desc: t('家人口味、孩子学业、作息规律、采购清单、健康提醒', 'Family preferences, children\'s studies, daily schedules, shopping lists, health reminders') },
