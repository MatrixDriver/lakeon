...
.tool-card:hover {
  box-shadow: var(--pub-shadow, 0 4px 16px rgba(0,0,0,0.10));
  border-color: var(--pub-primary, #0073e6);
}
.tool-card-hd {
  display: flex;
  align-items: center;
...
@media (max-width: 768px) {
  ...
  .quickstart-section { padding: 36px 20px; }
  .tools-section { padding: 36px 20px; }
  .tools-grid { grid-template-columns: 1fr; }
  .protocols-section { padding: 36px 20px; }
  .protocols-grid { grid-template-columns: 1fr 1fr; }
  .page-bottom-cta { padding: 36px 20px; }
}
